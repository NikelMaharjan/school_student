...
class TotalMarks {
  ...
  factory TotalMarks.fromJson(Map<String, dynamic> json) {
    return TotalMarks(
      id: json['id'],
      exam: ExamDetail.fromJson(json['exam']),
...
class ExamMarks {
  final int id;
  final String subject_full_marks;
  final String obtained_marks;
  final ClassSubject classSubject;
  final TotalMarks totalMarks;

  ExamMarks({
    required this.id,
    required this.subject_full_marks,
  ...
  factory ExamMarks.fromJson(Map<String, dynamic> json) {
    return ExamMarks(
        id: json['id'],
        subject_full_marks: json['subject_full_marks'],
        obtained_marks: json['obtained_marks'],
        totalMarks: TotalMarks.fromJson(json['total_marks']),
