...
import 'package:eschool/features/view_page/homepage_parents/menu_items_parents/assignment_parents/assignment_page_parents.dart';
...
class AssignmentItems extends ConsumerWidget {
  final int subject;
  final int student_id;
  final String className;
  final String section;
  AssignmentItems({required this.subject,required this.student_id,required this.section,required this.className});
  ...
  Widget build(BuildContext context,ref) {
    ...
    return assignmentInfo.when(
        data: (data){
                  ...
                  child: Stack(
                      children:[
                        ...
                        Align(
                          ...
                          child: ListTile(
                            onTap:()=>  Get.to(()=>AssignmentPageParents(assignment: assignment[index], student_id: student_id, className: className, section: section,)),
          ...
          return Center(child: Text('No Assignment',style: TextStyle(color: Colors.black,fontSize: 22.sp,fontWeight: FontWeight.bold),));
