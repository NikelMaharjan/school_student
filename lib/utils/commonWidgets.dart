          ...
          child: ClipRRect(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                width: 90.w,
                color: color,
                child: assetPath != null ?Center(
                  child: Image.asset(
                    assetPath!,
                    width: 50.w,
                    height: 50.h,
                  ),
                ):Center(child: Text(label!, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30),)),
              ),
            ),
          ),
        ),
...
class GridTileButton extends StatelessWidget {
  ...
  GridTileButton({required this.title, required this.imagePath, required this.onTap});
            ...
            child: Row(
              children: [
                Container(
                    ...
                    width: 70.w,
                  child: Center(
                      child: Text(subjectName.substring(0,1),
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20
                        ),
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                        ...
                        children: [
                          Text(time,
                              style: TextStyle(
                                  color: Colors.black, fontSize: 11.sp, letterSpacing: 2)),
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                color: bgColor, // you can customize the color here
              ),
              child: Icon(
                icon,
                size: 35.sp,
          ...
          subtitle: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    'Status: $status',
                    style: TextStyle(fontSize: 12.sp, color: status=='Paid'? pre_color:abs_color),
                  ),
                ],
              )
          ),
          trailing: Icon(Icons.arrow_circle_right_rounded,color: Colors.black,size: 15.sp,),
...
class FeeCard2 extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Icon(Icons.arrow_circle_right_rounded,color: Colors.black,size: 15.sp,)
                    ],
                  ),
                ],
              )
...
class GridShimmer2 extends StatelessWidget {
  const GridShimmer2({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      padding: EdgeInsets.zero,
      shrinkWrap: true,
      itemCount: 5, // the number of grid tiles to show in the loading state
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        childAspectRatio: 2.w / 1.3.h,
        crossAxisCount: 3,
        mainAxisSpacing: 5.h,
